          ...
          <div className="container mx-10 mt-10">
            <div className="mt-5">
              ...
              <input
                type="text"
                id="form_name"
                className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500  dark:text-white  dark:focus:border-blue-500 dark:focus:ring-blue-500 md:w-80"
                placeholder="John"
                required
              />
            </div>
              ...
              <div className="mb-6">
                ...
                <div className="mb-4 mt-4 flex items-center">
                  <input
                    id="show-form"
                    type="checkbox"
                    className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500  dark:ring-offset-gray-800 dark:focus:ring-blue-600"
                    checked={showForm}
                ...
                <div class="pb-4">
                  ...
                  <div class="relative mt-1">
                    ...
                    <input
                      type="text"
                      id="table-search"
                      class="block w-80 rounded-lg border border-gray-300 bg-gray-50 p-2 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500  dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                      placeholder="Search "
                    />
                  </div>
                </div>
